$(document).ready(function () {
    ...
    function deleteProcedure(buy_code) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "procedure/" + buy_code,
            "method": "DELETE",
            "headers": {
                "cache-control": "no-cache",
    ...
    function updateProcedure(data, buy_code) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "procedure/" + buy_code,
                ...
                $('#myModal').modal().one('shown.bs.modal', function (e) {
                    ...
                    $("#savetheprocedure").off("click").on("click", function(e) {
                        ...
                        if(instance.isValid()){
                            ...
                            updateProcedure(jsondata, data.buy_code)
                        }
